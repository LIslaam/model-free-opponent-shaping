...
for s in {0..2..1}; do
  python3 src/eval_mfos_ppo.py --game=IPD --opponent=NL --exp_name=mfos_ppo_ipd_nl_"$s"  --seed="$s"
  python3 src/eval_mfos_ppo.py --game=random --opponent=NL --exp_name=mfos_ppo_random_nl_"$s"  --seed="$s"
