...
python src/main_mfos_rnn.py --game=noisyIPD --opponent=NL --exp_name=DATA_COLLECTION_mfos_rnn_input_noisyipd_randopp_nl --rand_opp=True --collect_data=True --append_input=True
python src/main_mfos_rnn.py --game=noisyIPD --opponent=NL --exp_name=DATA_COLLECTION_mfos_rnn_noisyipd_randopp_nl --rand_opp=True --collect_data=True



#for s in {0..4..1}; do
 #  python src/eval_mfos_ppo.py --game=IPD --opponent=NL --exp_name=mfos_ppo_ipd_opplr_0_05_nl_run2 --opp_lr=0.05 --seed="$s" --checkpoint=1024
