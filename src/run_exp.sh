...
for s in {0..2..1}; do
  ...
  #python3 src/eval_mfos_ppo.py --game=randIPD --opponent=LOLA --exp_name=mfos_ppo_randipd_lola_"$s"  --seed="$s"
  python3 src/main_mfos_ppo.py --game=noisyIPD --opponent=LOLA --exp_name=mfos_ppo_noisyipd_x5e-1_lola_"$s"  --seed="$s"
done
